...
public class Board {
    ...
    //CREATE ENUM FOR ORIENTATION

    //CREATE SEPARATE ENUM FOR FENCE TYPE

    //BOARD CONSTURCTOR WILL TAKE IN TWO ARRAYS
    //ONE ARRAY WILL BE USE TO SPECIFY THE TYPE OF FENCE
    //SECOND ARRAY WILL BE USED TO SPECIFY THE CORRECT ORIENTATION OF FENCE
